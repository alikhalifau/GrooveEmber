...
const contractABI = require("../artifacts/contracts/Grooveember.sol/Grooveember.json").abi;

program
    .name("grooveember-cli")
    .description("CLI tool for Grooveember smart contract")
    .version("1.0.0");
